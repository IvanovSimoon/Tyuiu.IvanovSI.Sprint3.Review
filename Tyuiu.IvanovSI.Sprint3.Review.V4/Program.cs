...
using Tyuiu.IvanovSI.Sprint3.Review.V4.Lib;
namespace Tyuiu.IvanovSI.Sprint3.Review.V4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* вычислить значение функции y = ((2 * x + 6) / (Math.Cos(x) + x)) - 3     *");
            Console.WriteLine("****************************************************************************");
